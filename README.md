...
- Oct. 30th (**Room 1Z18**): Lecture 4 (M. Ovsjanikov): ([Slides](slides/MVA_lecture4_cmp.pdf), [Lab](td/TD_4.ipynb), [Quizz](https://surveyjs.io/published?id=e4c3a627-6f66-4fcb-ba1a-217dafd897b7), [Quizz with special permission](https://surveyjs.io/published?id=c4d2d521-1c4a-4175-9e5a-5701197a944e)) Projection-based approaches. Learning on Point clouds. Common point-based architectures (PointNet, PointNet++, DGCNN, KPConv, etc.). Applications (surface reconstruction, point cloud filtering).
